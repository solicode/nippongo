...
(extend-protocol IJapaneseText
  ...
  String
  (hiragana? [coll] (every-char? hiragana? coll))
  (half-width-katakana? [coll] (every-char? half-width-katakana? coll))
  (full-width-katakana? [coll] (every-char? full-width-katakana? coll))
  (katakana? [coll] (every-char? katakana? coll))
  (kana? [coll] (every-char? kana? coll))
  (kanji? [coll] (every-char? kanji? coll))
  (half-width-lowercase-letter? [coll] (every-char? half-width-lowercase-letter? coll))
  (half-width-uppercase-letter? [coll] (every-char? half-width-uppercase-letter? coll))
  (full-width-lowercase-letter? [coll] (every-char? full-width-lowercase-letter? coll))
  (full-width-uppercase-letter? [coll] (every-char? full-width-uppercase-letter? coll))
  (half-width-letter? [coll] (every-char? half-width-letter? coll))
  (full-width-letter? [coll] (every-char? full-width-letter? coll))
  (letter? [coll] (every-char? letter? coll))
  (half-width-digit? [coll] (every-char? half-width-digit? coll))
  (full-width-digit? [coll] (every-char? full-width-digit? coll))
  (digit? [coll] (every-char? digit? coll))
  (romaji? [coll] (every-char? romaji? coll))
  (->dakuten [coll] (map-string ->dakuten coll))
  (->handakuten [coll] (map-string ->handakuten coll))
  (full-width-hiragana->full-width-katakana [coll] (map-string full-width-hiragana->full-width-katakana coll))
  (full-width-katakana->full-width-hiragana [coll] (map-string full-width-katakana->full-width-hiragana coll))
